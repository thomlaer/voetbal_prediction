...
5. Enable `update_soccerbase=true` only when you deliberately want to check Soccerbase for new lineups/stats/cards. This runs incrementally: existing Soccerbase game ids are skipped.
